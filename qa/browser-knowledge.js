...
(async()=>{
 ...
 try{
  ...
  await p.evaluate(()=>{document.querySelector('.picker-overlay')?.remove();document.body.classList.remove('picker-open');[...document.querySelectorAll('.tab')].find(b=>b.dataset.tab==='battle')?.click();});
