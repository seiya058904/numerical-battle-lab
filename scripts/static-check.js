...
for(const runtime of ['src/kernel.js','src/components.js','src/rules.js','src/content.js','src/status-runtime.js','src/formula.js','src/validator.js','src/effects.js','src/engine.js','src/power.js','src/gen-stats.js','src/gen-skills.js','src/generator.js','src/gen-names.js','src/gen-v2.js','src/battlepower-model.js','src/battlepower.js','src/card-ui.js','src/app.js'])if(!html.includes(runtime))throw new Error(`runtime script missing from index: ${runtime}`);
