...
if(require.main===module){
  ...
  console.log(JSON.stringify({atk:r.atk.ok,lifesteal:r.lifesteal.ok,volatility:r.volatility.ok,ramp:r.ramp.ok,fatigue:r.fatigue.ok,healPower:r.healPower.ok,allOk:r.allOk,details:{atk:{low:r.atk.low,high:r.atk.high},lifesteal:{z:r.lifesteal.zero,f:r.lifesteal.fifty},vol:{ls:r.volatility.lowStd,hs:r.volatility.highStd},ramp:{c:r.ramp.controlLast,f:r.ramp.rampFirst,l:r.ramp.rampLast},fatigue:{c:r.fatigue.controlLast,f:r.fatigue.fatigueFirst,l:r.fatigue.fatigueLast},heal:{p100:r.healPower.p100,p200:r.healPower.p200}}}));
