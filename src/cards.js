...
(function (global) {
  ...
  const CARDS = [
    ...
    /* ---------- C+ ---------- */
    { id: 'berserker', name: '狂暴战士', rarity: 1, role: '吸血', desc: '越战越勇，靠吸血维持战线。',
    ...
    /* ---------- B+ ---------- */
    { id: 'corruptor', name: '腐蚀术士', rarity: 3, role: '侵蚀', desc: '高穿透与持续再生，缓慢瓦解敌人。',
    ...
    /* ---------- A+ ---------- */
    { id: 'frost_mage', name: '霜冻法师', rarity: 5, role: '法师', desc: '高速高闪避，扰乱敌方节奏。',
    ...
    { id: 'dragon_knight', name: '龙血骑士', rarity: 6, role: '吸血', desc: '高耐久吸血战士，越打越难杀死。',
    ...
    /* ---------- SS ---------- */
    { id: 'lava_lord', name: '熔岩领主', rarity: 7, role: '灼烧', desc: '高耐久再生，稳步消耗敌人。',
    ...
    { id: 'storm_valkyrie', name: '风暴女武神', rarity: 7, role: '连击', desc: '极速机动配合高暴击，越打越快。',
    ...
    /* ---------- SSS ---------- */
    { id: 'time_traveler', name: '时空旅者', rarity: 8, role: '极速', desc: '操纵速度差，令对手难以命中。',
    ...
    { id: 'thunder_god', name: '雷霆战神', rarity: 8, role: '神罚', desc: '纯粹的破坏力，一击可定胜负。',
    ...
    { id: 'primordial_dragon', name: '原初之龙', rarity: 10, role: '龙威', desc: '原初时代的巨龙，以龙威压制万物。',
    ...
    /* ---------- XS Collector ---------- */
    { id: 'avatar_of_the_end', name: '终焉化身', rarity: 11, role: '终焉', desc: '一切数值的终点，全维度登峰。',
      base: { hp: 1.25, atk: 1.18, def: 1.15, spd: 1.25 },
      acc: 112, eva: 102, crit: 0.11, critDmg: 1.60, pen: 0.12, lifesteal: 0.05, hpRegen: 0.004, volatility: 0.12 },
    { id: 'origin_star', name: '起源之星', rarity: 11, role: '奇点', desc: '万物起源的一击，爆发力无穷。',
      base: { hp: 1.00, atk: 1.32, def: 0.95, spd: 1.30 },
      acc: 114, eva: 100, crit: 0.15, critDmg: 1.70, pen: 0.18, lifesteal: 0.05, hpRegen: 0, volatility: 0.18 }
  ];
